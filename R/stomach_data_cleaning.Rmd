...
full_dat <- get_sub_area(dat = full_dat, lat = full_dat$Lat, lon = full_dat$Long)

full_dat <- full_dat %>% drop_na(sub_area) %>% mutate(sub_area = as.factor(sub_area))
...
```{r, save}
write.csv(full_dat, "data/for_analysis/stomach/full_stomach_data_21.06.09.csv")

# Only recent years
sub_full_dat <- filter(full_dat, Year > 2014)
write.csv(sub_full_dat, "data/for_analysis/stomach/2015-2018_stomach_data_21.06.09.csv")
```
