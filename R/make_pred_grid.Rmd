...
# Now modify them...
pred_grid2 <- pred_grid2 %>% mutate(sub_area = ifelse(lat > 56.1 & sub_area == 2, "3", sub_area))
...
pred_grid2 <- pred_grid2 %>% mutate(sub_area = ifelse(lat > 55.44 & sub_area == 1, "2", sub_area))
