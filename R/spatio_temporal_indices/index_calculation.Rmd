...
# Sub-area 25
sad_preds25 <- predict(m_sad, filter(pred_grid_sad, sub_area == 25),
...
# Sub-area 27
sad_preds27 <- predict(m_sad, filter(pred_grid_sad, sub_area == 27),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# Sub-area 28
sad_preds28 <- predict(m_sad, filter(pred_grid_sad, sub_area == 28),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# Sub-area 25
amp_preds25 <- predict(m_amp, filter(pred_grid_amp, sub_area == 25),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# Sub-area 27
amp_preds27 <- predict(m_amp, filter(pred_grid_amp, sub_area == 27),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# Sub-area 28
amp_preds28 <- predict(m_amp, filter(pred_grid_amp, sub_area == 28),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# Sub-area 25
myt_preds25 <- predict(m_myt, filter(pred_grid_myt, sub_area == 25),
                   return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells25 <- pred_grid_myt %>% filter(year == 2015 & sub_area == 25) %>% nrow()
...
# Sub-area 27
myt_preds27 <- predict(m_myt, filter(pred_grid_myt, sub_area == 27),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells27 <- pred_grid_myt %>% filter(year == 2015 & sub_area == 27) %>% nrow()
...
# Sub-area 28
myt_preds28 <- predict(m_myt, filter(pred_grid_myt, sub_area == 28),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells28 <- pred_grid_myt %>% filter(year == 2015 & sub_area == 28) %>% nrow()
...
# Sub-area 25
lim_preds25 <- predict(m_lim, filter(pred_grid_lim, sub_area == 25),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells25 <- pred_grid_lim %>% filter(year == 2015 & sub_area == 25) %>% nrow()
...
# Sub-area 27
lim_preds27 <- predict(m_lim, filter(pred_grid_lim, sub_area == 27),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells27 <- pred_grid_lim %>% filter(year == 2015 & sub_area == 27) %>% nrow()
...
# Sub-area 28
lim_preds28 <- predict(m_lim, filter(pred_grid_lim, sub_area == 28),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells28 <- pred_grid_lim %>% filter(year == 2015 & sub_area == 28) %>% nrow()
...
# Sub-area 25
pol_preds25 <- predict(m_pol, filter(pred_grid_pol, sub_area == 25),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells25 <- pred_grid_pol %>% filter(year == 2015 & sub_area == 25) %>% nrow()
...
# Sub-area 27
pol_preds27 <- predict(m_pol, filter(pred_grid_pol, sub_area == 27),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells27 <- pred_grid_pol %>% filter(year == 2015 & sub_area == 27) %>% nrow()
...
# Sub-area 28
pol_preds28 <- predict(m_pol, filter(pred_grid_pol, sub_area == 28),
                       return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells28 <- pred_grid_pol %>% filter(year == 2015 & sub_area == 28) %>% nrow()
...
# Sub-area 25
cuma_preds25 <- predict(m_cuma, filter(pred_grid_cuma, sub_area == 25),
                        return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells25 <- pred_grid_cuma %>% filter(year == 2015 & sub_area == 25) %>% nrow()
...
# Sub-area 27
cuma_preds27 <- predict(m_cuma, filter(pred_grid_cuma, sub_area == 27),
                        return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells27 <- pred_grid_cuma %>% filter(year == 2015 & sub_area == 27) %>% nrow()
...
# Sub-area 28
cuma_preds28 <- predict(m_cuma, filter(pred_grid_cuma, sub_area == 28),
                        return_tmb_object = TRUE) # Predict using the grid for subarea
...
# First multiply by the area of a grid cell to get raw g
# Then divide that by the total area
ncells28 <- pred_grid_cuma %>% filter(year == 2015 & sub_area == 28) %>% nrow()
